...
class CustomConfigurationList extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $options = ['attributes' => ['title' => $this->t('View Live Example')]];
    // Fetch all configuration list.
    ...
    foreach ($result_list as $list) {
      ...
      $link = Link::createFromRoute($list->custom_config_machine_name, 'custom_configuration.example', ['machine_name' => $list->custom_config_machine_name], $options)->toString();
      ...
      $form['config-list'][$list->custom_config_id]['custom_config_status'] = [
        '#markup' => ($list->custom_config_status == 1) ? $this->t('ACTIVE') : $this->t('INACTIVE'),
      ];
